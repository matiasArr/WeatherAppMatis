...
public class ActivityC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //datosAProfundidadDeCiudad(lat,lon);

    }
    public void searchWithPosition(String lat,String lon){
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://api.openweathermap.org/geo/1.0/reverse?lat="+lat+"&lon="+lon+"&appid=0c6e0566dd523e8054a8bb5944ea320f";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONObject a = reader.getJSONObject(0);
                    String aux = a.getString("name");
                    buscarCuidad(aux);
